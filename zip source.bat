...
robocopy .\ %tempfolder% /MIR /XD .svn obj /XF "Radio Downloader.exe" "Radio Downloader.exe.config" "Radio Downloader.pdb" "Radio Downloader.vshost.exe" "Radio Downloader.vshost.exe.config" "Radio Downloader.xml" System.Data.SQLite.DLL System.Data.SQLite.xml "Radio Downloader.suo" "Radio Donloader.msi" "Radio Downloader.wixobj" "Radio Downloader.log" "*.vbproj.user"
